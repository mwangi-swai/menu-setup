...
const displayMenuItems = (menuItems) => {
  let sectionDisplay = menuItems.map((item) => {
    return ` <article class="menu-item">
  ...
  sectionDisplay = sectionDisplay.join(" ");
  sectionCenter.innerHTML = sectionDisplay;
...
// Adding Filter Buttons Dynamically
/* Get only the unique categories
Iterate over the categories and return the buttons
